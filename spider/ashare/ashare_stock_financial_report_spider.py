...
class StockFinancialReportSpider(BaseSpider):
    ...
    _COLUMN_MAP = {
            "资产负债表": {
                ...
                "应付债券": "bonds_payable",
                "长期应付款合计": "total_long_term_payables",
                ...
                "外币报表折算差额": "currency_translation_differences",
            ...
            "利润表": {
                ...
                "对联营企业和合营企业的投资收益": "income_from_associates_and_joint_ventures",
                "公允价值变动收益": "gain_on_fair_value_changes",
                "补贴收入": "subsidy_income",
                "其他收益": "other_income",
                "资产减值损失": "asset_impairment_loss",
                "信用减值损失": "credit_impairment_loss",
                "其他业务利润": "other_operating_profit",
                "资产处置收益": "gain_on_asset_disposal",
                "营业外收入": "non_operating_income",
                "非流动资产处置利得": "gain_on_disposal_non_current_assets",
                "营业外支出": "non_operating_expenses",
                "非流动资产处置损失": "loss_on_disposal_non_current_assets",

                "营业利润": "operating_profit",
                "利润总额": "total_profit",
                "所得税费用": "income_tax_expenses",
                "净利润": "net_profit",
                "持续经营净利润": "net_profit_continuing_ops",
                "归属于母公司所有者的净利润": "net_profit_attributable_to_parent",
                "少数股东损益": "minority_interests_income",
            ...
            "现金流量表": {
                "报告日": "date",
                "销售商品、提供劳务收到的现金": "cash_from_sales_and_services",
                "收到的税费返还": "tax_refunds",
                "收到的其他与经营活动有关的现金": "other_cash_from_operating_activities",
                "经营活动现金流入小计": "subtotal_operating_cash_inflow",
                
                "购买商品、接受劳务支付的现金": "cash_paid_for_goods_and_services",
                "支付给职工以及为职工支付的现金": "cash_paid_to_employees",
                "支付的各项税费": "cash_paid_for_taxes",
                "支付的其他与经营活动有关的现金": "other_cash_paid_for_operating_activities",
                "经营活动现金流出小计": "subtotal_operating_cash_outflow",
                "经营活动产生的现金流量净额": "net_cash_flow_from_operating_activities",

                "收回投资所收到的现金": "cash_received_from_investment_recovery",
                "取得投资收益收到的现金": "cash_received_from_investment_returns",
                "处置固定资产、无形资产和其他长期资产所收回的现金净额": "net_cash_from_disposal_of_long_term_assets",
                "处置子公司及其他营业单位收到的现金净额": "net_cash_from_disposal_of_subsidiaries",
                "收到的其他与投资活动有关的现金": "other_cash_from_investing_activities",
                "投资活动现金流入小计": "subtotal_investing_cash_inflow",

                "购建固定资产、无形资产和其他长期资产所支付的现金": "cash_paid_for_long_term_assets",
                "投资所支付的现金": "cash_paid_for_investments",
                "取得子公司及其他营业单位支付的现金净额": "net_cash_paid_for_subsidiaries",
                "支付的其他与投资活动有关的现金": "other_cash_paid_for_investing_activities",
                "投资活动现金流出小计": "subtotal_investing_cash_outflow",
                "投资活动产生的现金流量净额": "net_cash_flow_from_investing_activities",

                "吸收投资收到的现金": "cash_received_from_equity_investments",
                "子公司吸收少数股东投资收到的现金": "cash_received_from_minority_investments",
                "取得借款收到的现金": "cash_received_from_borrowings",
                "收到其他与筹资活动有关的现金": "other_cash_from_financing_activities",
                "筹资活动现金流入小计": "subtotal_financing_cash_inflow",

                "偿还债务支付的现金": "cash_paid_for_debt_repayment",
                "分配股利、利润或偿付利息所支付的现金": "cash_paid_for_dividends_and_interest",
                "子公司支付给少数股东的股利、利润": "dividends_paid_to_minority_shareholders",
                "支付其他与筹资活动有关的现金": "other_cash_paid_for_financing_activities",
                "筹资活动现金流出小计": "subtotal_financing_cash_outflow",
                "筹资活动产生的现金流量净额": "net_cash_flow_from_financing_activities",

                "汇率变动对现金及现金等价物的影响": "effect_of_exchange_rate_changes",
                "现金及现金等价物净增加额": "net_increase_in_cash_and_equivalents",
                "期初现金及现金等价物余额": "cash_and_equivalents_at_beginning",
